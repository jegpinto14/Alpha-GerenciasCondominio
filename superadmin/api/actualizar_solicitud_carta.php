...
$estadoEntrada = isset($entrada['estado']) ? strtolower(trim((string) $entrada['estado'])) : '';
...
try {
    $stmt = $pdo->prepare('UPDATE solicitudes_cartas SET estado = :estado WHERE carta_id = :id');
