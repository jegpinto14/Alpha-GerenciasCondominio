...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 31, 2025 at 05:03 PM
...
CREATE TABLE IF NOT EXISTS `banco_emisor_gastos` (
  ...
  `nombre_cuenta` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nombre identificador de la cuenta del condominio',
  `tipo_cuenta` enum('corriente','ahorro','nomina') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'corriente',
  `numero_cuenta` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Número de cuenta del condominio',
  `titular_cuenta` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Condominio Arcorui',
...
CREATE TABLE IF NOT EXISTS `banco_receptor_gastos` (
  ...
  `tipo_cuenta` enum('corriente','ahorro') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'corriente',
  `numero_cuenta` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Número de cuenta del proveedor',
...
CREATE TABLE IF NOT EXISTS `cuentas_contables` (
  ...
  `codigo_cuenta` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Código único de la cuenta',
  `nombre_cuenta` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nombre de la cuenta contable',
...
CREATE TABLE IF NOT EXISTS `obligaciones` (
  ...
  `concepto` text COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Descripción del gasto',
  `aprobado_por` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Persona que aprobó el gasto',
  `fecha_aprobacion` date DEFAULT NULL,
  `frecuencia_pago` enum('unico','mensual','bimensual','trimestral','anual') COLLATE utf8mb4_general_ci DEFAULT 'mensual',
...
INSERT INTO `obligacion_periodo` (`obligacion_periodo_id`, `obligacion_id`, `periodo_id`, `estado`) VALUES
(1, 9, 12, 'Pagado'),
(2, 12, 12, 'Pagado'),
(3, 1, 12, 'Por Pagar'),
(5, 3, 12, 'Por Pagar'),
...
CREATE TABLE IF NOT EXISTS `pagos_proveedores` (
  ...
  `numero_referencia` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Número de referencia bancaria',
  `documento_respaldo_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Ruta del comprobante escaneado',
  `estado` enum('registrado','confirmado','anulado') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'registrado',
  `notas` text COLLATE utf8mb4_general_ci,
  `registrado_por` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Usuario que registró el pago',
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `proveedores` (
  ...
  `nombre_razon_social` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Nombre o razón social del proveedor',
  `tipo_documento` enum('V','J','E') COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `notas` text COLLATE utf8mb4_general_ci COMMENT 'Observaciones adicionales',
  `estado` enum('activo','inactivo') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'activo' COMMENT 'Estado del proveedor',
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
